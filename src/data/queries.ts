...
export const mockQueries: QueryResult[] = [
  ...
  {
    id: "q7",
    query: "ALTER TABLE payments ADD COLUMN confirmed",
    status: "completed",
    durationMs: 6000,
  },
  {
  ...
  {
    id: "q10",
    query: "TRUNCATE TABLE old_backups",
    status: "failed",
    durationMs: 300,
  },
  {
  ...
  {
    id: "q13",
    query: "REINDEX TABLE search_index",
    status: "completed",
    durationMs: 7100,
  },
  {
...
// ---
// STRETCH: Async fetch of data
// 1. Fetch data from getQueries() in src/data/queries.ts
// 2. Show loading state while fetching

export const getQueries = (): Promise<QueryResult[]> => {
  return new Promise((resolve) => {
    setTimeout(() => {
      new Promise((resolve) => resolve(mockQueries));
